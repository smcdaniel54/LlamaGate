...
**The extension system has been removed.** All `/v1/extensions` endpoints and dynamic extension routes return **404**. See [Core Contract](core_contract.md) and [Phase 1 Removal](phase1_remove_modules_extensions.md) for current scope and migration.
